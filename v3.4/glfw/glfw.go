...
const (
	...
	ModCapsLock ModifierKey = base.ModCapsLock
	ModNumLock  ModifierKey = base.ModNumLock
	...
	LockKeyMods        InputMode = base.LockKeyMods
	RawMouseMotion     InputMode = base.RawMouseMotion
	...
	// Standard cursor shapes (v3.1 originals + v3.4 additions)
	...
	ResizeEWCursor     StandardCursorShape = base.ResizeEWCursor
	ResizeNSCursor     StandardCursorShape = base.ResizeNSCursor
	ResizeNWSECursor   StandardCursorShape = base.ResizeNWSECursor
	ResizeNESWCursor   StandardCursorShape = base.ResizeNESWCursor
	ResizeAllCursor    StandardCursorShape = base.ResizeAllCursor
	PointingHandCursor StandardCursorShape = base.PointingHandCursor
	NotAllowedCursor   StandardCursorShape = base.NotAllowedCursor

	// Platform IDs (v3.4)
	AnyPlatform     Platform = base.AnyPlatform
	PlatformWin32   Platform = base.PlatformWin32
	PlatformCocoa   Platform = base.PlatformCocoa
	PlatformWayland Platform = base.PlatformWayland
	PlatformX11     Platform = base.PlatformX11
	PlatformNull    Platform = base.PlatformNull

	// Window / context hints (full v3.3 set + v3.4 additions)
	...
	CenterCursor            Hint = base.CenterCursor
	TransparentFramebuffer  Hint = base.TransparentFramebuffer
	Hovered                 Hint = base.Hovered
	FocusOnShow             Hint = base.FocusOnShow
	...
	ContextReleaseBehavior  Hint = base.ContextReleaseBehavior
	ContextNoError          Hint = base.ContextNoError
	ContextCreationAPIHint  Hint = base.ContextCreationAPIHint
	ScaleToMonitor          Hint = base.ScaleToMonitor
	// v3.4 hints
	MousePassthrough Hint = base.MousePassthrough
	PositionX        Hint = base.PositionX
	PositionY        Hint = base.PositionY
	AnyPosition           = base.AnyPosition
	ScaleFramebuffer Hint = base.ScaleFramebuffer
	...
	OSMesaContextAPI  ContextCreationAPI = base.OSMesaContextAPI
	...
	// Gamepad axes
	AxisLeftX        GamepadAxis = base.AxisLeftX
	AxisLeftY        GamepadAxis = base.AxisLeftY
	AxisRightX       GamepadAxis = base.AxisRightX
	AxisRightY       GamepadAxis = base.AxisRightY
	AxisLeftTrigger  GamepadAxis = base.AxisLeftTrigger
	AxisRightTrigger GamepadAxis = base.AxisRightTrigger
	AxisLast                     = base.AxisLast

	// Gamepad buttons
	ButtonA           GamepadButton = base.ButtonA
	ButtonB           GamepadButton = base.ButtonB
	ButtonX           GamepadButton = base.ButtonX
	ButtonY           GamepadButton = base.ButtonY
	ButtonLeftBumper  GamepadButton = base.ButtonLeftBumper
	ButtonRightBumper GamepadButton = base.ButtonRightBumper
	ButtonBack        GamepadButton = base.ButtonBack
	ButtonStart       GamepadButton = base.ButtonStart
	ButtonGuide       GamepadButton = base.ButtonGuide
	ButtonLeftThumb   GamepadButton = base.ButtonLeftThumb
	ButtonRightThumb  GamepadButton = base.ButtonRightThumb
	ButtonDpadUp      GamepadButton = base.ButtonDpadUp
	ButtonDpadRight   GamepadButton = base.ButtonDpadRight
	ButtonDpadDown    GamepadButton = base.ButtonDpadDown
	ButtonDpadLeft    GamepadButton = base.ButtonDpadLeft
	ButtonLast                      = base.ButtonLast
	ButtonCross                     = base.ButtonCross
	ButtonCircle                    = base.ButtonCircle
	ButtonSquare                    = base.ButtonSquare
	ButtonTriangle                  = base.ButtonTriangle

	// Error codes (v3.3 set)
	...
	// v3.4 error codes
	PlatformUnavailable  ErrorCode = base.PlatformUnavailable
	FeatureUnavailable   ErrorCode = base.FeatureUnavailable
	FeatureUnimplemented ErrorCode = base.FeatureUnimplemented
...
func JoystickIsGamepad(joy Joystick) bool             { return base.JoystickIsGamepad(joy) }
func GetGamepadName(joy Joystick) string              { return base.GetGamepadName(joy) }
func GetGamepadState(joy Joystick, state *GamepadState) bool {
	return base.GetGamepadState(joy, state)
}
func UpdateGamepadMappings(mappings string) bool { return base.UpdateGamepadMappings(mappings) }
